...
dap.adapters.chrome = {
  ...
  args = {
    sep_os_replacer(
      global.dap_path .. "/vscode-chrome-debug/out/src/chromeDebug.js"
    ),
  },
}
...
dap.adapters.go = {
  ...
  command = "node",
  args = {
    sep_os_replacer(global.dap_path .. "/vscode-go/dist/debugAdapter.js"),
  },
}
...
dap.configurations.typescript = {
  {
      ...
      request = 'launch',
      cwd = vim.fn.getcwd(),
      runtimeArgs = {'--inspect-brk', vim.fn.getcwd() .. '/node_modules/.bin/jest', '--no-coverage', '--watch', '--runInBand',  '--config', vim.fn.getcwd() .. '/packages/stacks/customer/delivery-promise-service/src/__api__/jest.config.js', jestDapVars.testName},
      sourceMaps = true,
      protocol = 'auto',

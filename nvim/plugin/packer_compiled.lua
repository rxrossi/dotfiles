...
_G.packer_plugins = {
  ...
  ["sqlite.lua"] = {
    loaded = true,
    path = "/Users/rxrossi/.local/share/nvim/site/pack/packer/start/sqlite.lua",
  ...
  ["telescope-frecency.nvim"] = {
    ...
    loaded = true,
    path = "/Users/rxrossi/.local/share/nvim/site/pack/packer/start/telescope-frecency.nvim",
